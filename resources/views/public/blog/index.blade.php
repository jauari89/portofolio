...
@section('title', 'Blog | '.($setting->site_name ?? 'Jauari Akhmad'))
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-4">
            <div>
                ...
                <h1 class="fw-bold mt-2">Articles and Notes</h1>
            </div>
            <div class="d-flex flex-wrap gap-2 align-self-lg-end">
                <a href="{{ route('blog.index') }}" class="btn btn-sm {{ $selectedCategory ? 'btn-outline-primary' : 'btn-primary' }}">All</a>
        ...
        <div class="row g-4">
            ...
            @empty
                <div class="col-12"><div class="alert alert-info">Artikel akan tampil setelah dipublikasikan dari admin panel.</div></div>
            @endforelse
        </div>
